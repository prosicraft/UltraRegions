...
public class MLog
{
	...
	{
		System.out.println( real( col + MConst._OUT_PREFIX + "::INFO] " + txt ) );
	}
	...
	{
		System.out.println( real( col + MConst._OUT_PREFIX + "::SUCCESS] " + txt ) );
	}
	...
	{
		System.out.println( real( col + MConst._OUT_PREFIX + "::ERROR] " + txt ) );
	}
	...
	{
		System.out.println( real( col + MConst._OUT_PREFIX + "::WARNING] " + txt ) );
	}
	...
	public static void d( String txt, ChatColor col )
	{
		if( MConst._DEBUG_ENABLED )
			System.out.println( real( col + MConst._OUT_PREFIX + "::DEBUG] " + txt ) );
	}
